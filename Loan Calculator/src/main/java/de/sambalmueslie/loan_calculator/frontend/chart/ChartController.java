 ...
 */
public class ChartController<T extends BusinessObject> implements Chart<T> {
	...
	/**
	 * @see de.sambalmueslie.loan_calculator.frontend.chart.Chart#add(java.lang.Object)
	 */
	...
	/**
	 * @see de.sambalmueslie.loan_calculator.frontend.chart.Chart#getChart()
	 */
	@Override
	...
	/**
	 * @see de.sambalmueslie.loan_calculator.frontend.chart.Chart#remove(java.lang.Object)
	 */
	@SuppressWarnings("unchecked")
	@Override
