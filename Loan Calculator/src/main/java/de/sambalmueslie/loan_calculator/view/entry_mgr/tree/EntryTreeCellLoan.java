 ...
 */
public class EntryTreeCellLoan extends GridPane implements EntryTreeCellContent<Loan> {

	/** the {@link Logger}. */
	private static Logger logger = LogManager.getLogger(EntryTreeCellLoan.class);

	/**
	 * Constructor.
	 */
	public EntryTreeCellLoan() {
